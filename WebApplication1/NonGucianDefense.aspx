<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NonGucianDefense.aspx.cs" Inherits="WebApplication1.NonGucianDefense" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" CssClass="auto-style3" Text="Enter Thesis No."></asp:Label>
