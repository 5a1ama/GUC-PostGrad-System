<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminViewPayment.aspx.cs" Inherits="WebApplication1.AdminViewPayment" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Button4" runat="server" OnClick="Payment" Enabled="false" Text="View all payments" />
        </div>
        <p>
