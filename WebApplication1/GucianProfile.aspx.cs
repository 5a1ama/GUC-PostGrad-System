...
{
    public partial class GucianProfile : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (rdr.Read())
            {
                ...
                int intundergradID = rdr.GetInt32(rdr.GetOrdinal("undergradID"));
                Label undergradID = new Label();
                undergradID.Style.Add(HtmlTextWriterStyle.Position, "absolute");
                undergradID.Style.Add(HtmlTextWriterStyle.Left, "50px");
                undergradID.Style.Add(HtmlTextWriterStyle.Top, "460px");
                undergradID.Text = "undergradID:" + " " + intundergradID;
