...
{
    public partial class RegisterNon : System.Web.UI.Page
    {
        ...
        public static TextBox mobileT2 = new TextBox();
        public static bool finish;
        public static bool typeflag;
        public static bool gpaflag;
        public static int countNon = 0;
        public static int id12;

        protected void Page_Load(object sender, EventArgs e)
        {
            divNon.Controls.Add(mobileT2);
            for (int i = 0; i < 10; i++)
            {
                TextBox t = new TextBox();
                t.Visible = false;
                divNon.Controls.Add(t);
            }
            ...
            mobile.Style.Add(HtmlTextWriterStyle.Top, "540px");
            divNon.ID = "mobiles";
            divNon.Style.Add(HtmlTextWriterStyle.Position, "absolute");
            divNon.Style.Add(HtmlTextWriterStyle.Left, "300px");
            divNon.Style.Add(HtmlTextWriterStyle.Top, "540px");
            divNon.Style.Add(HtmlTextWriterStyle.Width, "1000px");
            divNon.Style.Add(HtmlTextWriterStyle.Height, "30px");
            divNon.Visible = true;
            mobileT2.Style.Add(HtmlTextWriterStyle.Position, "relative");



            for (int i = 0; i < countNon; i++)
            {
                divNon.Controls.OfType<TextBox>().ToArray()[i + 1].Visible = true;

            }
            form1.Controls.Add(divNon);
        ...
        {
            countNon++;
            divNon.Controls.OfType<TextBox>().ToArray()[countNon].Visible = true;
        ...
        protected void B3_Click(object sender, EventArgs e)
        {
            if (countNon != 0)
            {
                divNon.Controls.OfType<TextBox>().ToArray()[countNon].Visible = false;
        ...
        protected void Submit(object sender,EventArgs e)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@Gucian", false));
            ...
            conn.Open();
            SqlCommand cmd3;
            cmd3 = new SqlCommand("update NonGucianStudent set GPA=@type where id=@id", conn);
                ...
                if (GPAT.Text != "")
                {
                    try
                    {
                        ...
                        if (temp >= 0.7 && temp <= 6)
                        {
                            ...
                            cmd5 = new SqlCommand("update NonGucianStudent set type=@type where id=@id", conn);
                            ...
                            var arr = divNon.Controls.OfType<TextBox>().ToArray();
