...
{
    public partial class GucianAddFillProgressReport : System.Web.UI.Page
    {
        ...
        protected void FILL(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (succ.Value.ToString() == "True")
                {
                    ...
                    cmd2.ExecuteNonQuery();
                    conn.Close();
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('You have successfully Filled Progress Report')", true);
                    PRNoT1.Text = "";
                    ThSNoT1.Text = "";
                    STT.Text = "";
                    DCT.Text = "";
