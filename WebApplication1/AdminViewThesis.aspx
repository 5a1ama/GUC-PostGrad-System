<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminViewThesis.aspx.cs" Inherits="WebApplication1.AdminViewThesis" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            <asp:Button ID="Button2" runat="server" OnClick="AllThesis" Enabled="false" Text="List all thesis" />
